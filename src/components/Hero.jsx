                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <motion.div
                            ...
                            <a href="https://www.linkedin.com/in/mohammad-arsalan-408762256/"><FaLinkedin className='cursor-pointer' /></a>
                            <a href="https://github.com/mohammadarsalan777/"><FaGithub className='cursor-pointer' /></a>
                            <a href=""></a><span className='bg-neutral-900 text-sm hover:text-white box-border px-4 py-3 rounded-md text-neutral-400 w-28 text-center mx-1 cursor-pointer flex items-center justify-between'><BiDownload className="text-white" /> <span>Resume</span></span>
                ...
                <div className="w-full items-center lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img src={profilePic}
                            ...
                            className="object-cover rounded-xl h-[400px]" alt="Profile " />
                    </div>
                </div>
            </div>
        </div>
